...
class _ModoDificilScreenState extends State<ModoDificilScreen> {
  List<String> listaCartas = [
    ...
    'assets/CHAMPS/campeon9.png',
    'assets/CHAMPS/campeon10.png'
  ];
  ...
  void compararCartas() {
    ...
    if (cartasVisibles.isEmpty || !cartasVisibles.contains(true)) {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => VictoriaScreen(tiempo: cronometro.elapsedMilliseconds, nombreUsuario: widget.nombreUsuario, modoJuego: 'Difícil'),
        ),
      );
    }
  }

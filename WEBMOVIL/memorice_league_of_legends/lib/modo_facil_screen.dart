...
class ModoFacilScreen extends StatefulWidget {
  final String nombreUsuario;

  ModoFacilScreen(this.nombreUsuario);

  @override
  _ModoFacilScreenState createState() => _ModoFacilScreenState();
}

class _ModoFacilScreenState extends State<ModoFacilScreen> {
